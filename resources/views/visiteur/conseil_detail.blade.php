                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-5 ">
                                                    <div class="list-group ">  
                                                        ...
                                                        <div class="list-item text-bold row"><span class="font-weight-bold col-6">Description:</span> <span class="text-danger font-weight-bold ">
                                                            {{$conseil->description}}</span></div><br> 
