                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div id="external-events">
                      ...
                      <div class="external-event bg-warning"></div>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="input-group">
                      <input id="new-event" type="text" class="form-control" placeholder="Ajouter un evenement">
                      <div class="input-group">
                      <input id="new-events" type="text" class="form-control" placeholder="nombre de jour">
                      </div>
